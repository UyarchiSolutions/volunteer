...
@Component({
  selector: 'app-set-password-mobile',
  templateUrl: './set-password-mobile.component.html',
  styleUrls: ['./set-password-mobile.component.css'],
})
export class SetPasswordMobileComponent implements OnInit {
  constructor(
