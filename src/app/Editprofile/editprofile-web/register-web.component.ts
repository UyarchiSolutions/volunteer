...
@Component({
  selector: 'app-editprofile-web',
  templateUrl: './register-web.component.html',
  styleUrls: ['./register-web.component.css'],
})
export class EditprofileComponentWebComponent implements OnInit {
  constructor(
  ...
  submitForm() {
    ...
    if (this.profileForm.valid) {
      ...
      this.Api.updateVolunteer(this.profileForm.value).subscribe((e: any) => {
        if (this.fileName != '') {
