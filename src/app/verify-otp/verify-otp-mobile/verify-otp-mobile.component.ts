...
@Component({
  selector: 'app-verify-otp-mobile',
  templateUrl: './verify-otp-mobile.component.html',
  styleUrls: ['./verify-otp-mobile.component.css']
})
export class VerifyOtpMobileComponent implements OnInit, OnDestroy {
  constructor(
