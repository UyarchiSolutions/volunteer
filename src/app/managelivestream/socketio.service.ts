...
export class SocketioService {
  ...
  hand_raised_user(id: any): Observable<any> {
    return new Observable<any>(observer => {
      this.socket.on(id + "_join_raise_hands", (data: any) => {
        observer.next(data);
      });
      return () => {
        this.socket.disconnect();
  ...
  accept_raise_hand(channel: any): Observable<any> {
    return new Observable<any>(observer => {
      this.socket.on(channel + "_accept_stream", (data: any) => {
        observer.next(data);
      });
      return () => {
        this.socket.disconnect();
